...
class DuelingDeepQNetwork(keras.Model):
    ...
    #creates the DDDQN. self.V is the value generated for the state, and self.A
    #is the action advantage value generated.
    ...
    #model that only returns the action advantage values.
...
class ReplayBuffer():
    ...
    #initiates the memory component. The memories stored are memories of the
    #states, next states, actions, rewards, and whether or not the game ended.
    ...
    #plays the memories for the agent to learn from
